...
You probably want to execute a program on it, todo so go inside the **Memory** bloc then the **RAM** bloc and load the image of one of the programs allready programmed found inside the directory _/Programs_, you need to load one of the memory image file with the extenetion **.RAM**.
